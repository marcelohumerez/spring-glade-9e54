...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/spring-glade-9e54)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/spring-glade-9e54
```

A live public deployment of this template is available at [https://spring-glade-9e54.templates.workers.dev](https://spring-glade-9e54.templates.workers.dev)
